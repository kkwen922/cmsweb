  ...
  <div class="app-container">
    ...
    <div class="statistics-layout">
      ...
      <el-row>
        <el-col :span="12">
          <div class="out-border">
            <div class="layout-title">交易金額</div>
            <div style="padding: 10px;border-left:1px solid #DCDFE6">
              <div class="color-main address-content">
                <div id="SalesAmountGraph" style="height: 350px;"></div>
              </div>
            </div>
          </div>
        </el-col>
        ...
        <el-col :span="12">
          <div class="out-border">
            <div class="layout-title">熱賣商品</div>
            <div style="padding: 10px;border-left:1px solid #DCDFE6">
              <div class="color-main address-content">
                <div id="HotProdGraph" style="height: 350px;"></div>
              </div>
            </div>
          </div>
      ...
      <el-row>
        <el-col :span="12">
          <div class="out-border">
            <div class="layout-title">交易次數</div>
            <div style="padding: 10px;border-left:1px solid #DCDFE6">
              <div class="color-main address-content">
                <div id="SalesCountGraph" style="height: 350px;"></div>
              </div>
            </div>
          </div>
        </el-col>
        ...
        <el-col :span="12">
          <div class="out-border">
            <div class="layout-title">熱點銷冠</div>
            <div style="padding: 10px;border-left:1px solid #DCDFE6">
              <div class="color-main address-content">
                <div id="hotMachineGraph" style="height: 350px;"></div>
              </div>
            </div>
          </div>
