  ...
  <div class="app-container">
    ...
    <div class="table-container">
      <el-table ref="roleTable"
        ...
        <el-table-column label="用户數" width="100" align="center">
          <template slot-scope="scope">{{ scope.row.adminCount }}</template>
        </el-table-column>
        <el-table-column label="新增時間" width="160" align="center">
        ...
        <el-table-column label="操作" width="160" align="center">
          <template slot-scope="scope">
            <el-row>
              <el-button size="mini"
                         type="text"
                         @click="handleSelectMenu(scope.$index, scope.row)">分配選單
              </el-button>
              <el-button size="mini"
                         type="text"
